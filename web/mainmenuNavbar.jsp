...
<html style="height: auto;" class="">
    ...
    <body class="sidebar-mini sidebar-collapse control-sidebar-slide-open" data-gr-c-s-loaded="true" style="height: auto;">
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="max-height:  available">
            <!-- Brand Logo -->
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                ...
                                <li class="nav-item">
                                    <a href="tableRegionNewView.jsp" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Region</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="tableCountryNewView.jsp" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Country</p>
                                    </a>
                                </li><li class="nav-item">
                                    <a href="tableLocationNewView.jsp" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Location</p>
                                    </a>
                                </li></ul>
